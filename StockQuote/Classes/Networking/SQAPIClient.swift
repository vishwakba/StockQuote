...
open class SQAPIClient {
    // MARK: - Singleton Instance
    fileprivate static let _shared = SQAPIClient()
    
    fileprivate let kAPIBaseURLString = "https://api.sandbox.thirdparty.com/"
